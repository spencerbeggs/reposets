...
[#163]: https://github.com/spencerbeggs/reposets/pull/163
...
[#156]: https://github.com/spencerbeggs/reposets/pull/156
...
[#151]: https://github.com/spencerbeggs/reposets/pull/151
...
[#141]: https://github.com/spencerbeggs/reposets/pull/141
...
| @effected/app | dependency | updated | ^0.15.0 | ^0.16.1 |
| @effected/config-file | dependency | updated | ^0.7.0 | ^0.9.0 |
| @effected/github | dependency | updated | ^0.9.0 | ^0.10.1 |
| @effected/store | dependency | updated | ^0.7.0 | ^0.8.0 |
| @effected/toml | dependency | updated | ^0.6.0 | ^0.7.0 |
| @effected/xdg | dependency | updated | ^0.4.1 | ^0.5.1 |
...
[#134]: https://github.com/spencerbeggs/reposets/pull/134
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @effected/app | dependency | updated | ^0.14.0 | ^0.15.0 |
...
[#121]: https://github.com/spencerbeggs/reposets/pull/121
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @effected/app | dependency | updated | ^0.13.0 | ^0.13.1 |
...
[#100]: https://github.com/spencerbeggs/reposets/pull/100
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @effected/app | dependency | updated | ^0.12.1 | ^0.12.2 |
...
[#95]: https://github.com/spencerbeggs/reposets/pull/95
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @effected/app | dependency | updated | ^0.12.0 | ^0.12.1 |
...
[#92]: https://github.com/spencerbeggs/reposets/pull/92
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @effected/app | dependency | updated | ^0.11.1 | ^0.12.0 |
...
[#85]: https://github.com/spencerbeggs/reposets/pull/85
...
- | Dependency | Type | Action | From | To |  |
  | --- | --- | --- | --- | --- | --- |
  | @effected/config-file | dependency | updated | ^0.5.0 | ^0.5.1 | [#82][#82] Thanks [@spencerbeggs](https://github.com/apps/spencerbeggs)! |

### Patch Changes

[#82]: https://github.com/spencerbeggs/reposets/pull/82
...
- | Dependency | Type | Action | From | To |  |
  | --- | --- | --- | --- | --- | --- |
  | @effected/app | dependency | updated | ^0.11.0 | ^0.11.1 | [#74][#74] Thanks [@spencerbeggs](https://github.com/apps/spencerbeggs)! |

### Patch Changes

[#74]: https://github.com/spencerbeggs/reposets/pull/74
...
- | Dependency | Type | Action | From | To |  |
  ...
  | @effected/app | dependency | updated | 0.10.4 | 0.11.0 |  |
  ...
  | @effected/xdg | dependency | updated | 0.2.1 | 0.3.0 | Thanks [@spencerbeggs](https://github.com/spencerbeggs)! |

### Maintenance

- Rebuilds the published CLI against `effect` 4.0.0-rc.109, with matching `@effected/*` releases (`app`, `config-file`, `github`, `store`, `toml`, `xdg`) and `@effect/platform-node`.
...
- Rebuilt on Effect v4 and the `@effected/*` kit. `@effect/cli` does not exist on the v4 line; the CLI now uses `effect/unstable/cli` from core. The GitHub resource services and the libsodium sealed-box encryption used for secrets moved into `@effected/github`. [#63][#63]

### Major Changes

Thanks to [@spencerbeggs](https://github.com/spencerbeggs) for their contributions!

[#63]: https://github.com/spencerbeggs/reposets/pull/63

## 0.4.3

### Dependencies

- | [`28cf428`](https://github.com/spencerbeggs/reposets/commit/28cf428164c0a2a916df0b9568a99057739aec7f) | Dependency | Type | Action | From | To |
  | :-- | :-- | :-- | :-- | :-- | --- |
  ...
  | @savvy-web/bundler | devDependency | updated | ^0.6.1 | ^0.8.0 |  |
...
- | [`dfbfd27`](https://github.com/spencerbeggs/reposets/commit/dfbfd2709921f2318f1c753cbf9f79e881cc3333) | Dependency | Type | Action | From | To |
  | :-- | :-- | :-- | :-- | :-- | --- |
  | xdg-effect | dependency | updated | ^1.0.0 | ^1.0.1 |  |
